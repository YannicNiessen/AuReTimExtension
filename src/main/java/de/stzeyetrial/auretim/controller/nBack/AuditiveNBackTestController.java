...
import de.stzeyetrial.auretim.controller.nBack.AbstractNBackTestController;
...
public class AuditiveNBackTestController extends AbstractNBackTestController {
    ...
    public AuditiveNBackTestController(){
        super();
    ...
    protected void start() {
        ...
        final AbstractNBackTask task = new NBackTask(results, length, nOptions, nRepeat, nMatch, nLures, nBackLevel,  reUseElements, false, minimumResponseTime, timeout);
