 ...
 * @author strasser
 */
public class NBackInputTask extends AbstractInputTask {
	private final boolean _positive;

	public NBackInputTask(final CyclicBarrier gate, final long testStart, final int maximumTime, final int minimumResponseTime, final boolean positive) {
