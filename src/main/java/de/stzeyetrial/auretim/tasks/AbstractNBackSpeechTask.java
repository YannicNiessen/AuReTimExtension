...
public abstract class AbstractNBackSpeechTask extends Task<List<Result>>
{
    ...
    public AbstractNBackSpeechTask(final List<Result> results, final int length, final int nBackLevel, final int timeout){
        super();
        _results = results;
        _length = length;
