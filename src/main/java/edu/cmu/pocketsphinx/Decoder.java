...
public class Decoder {
  ...
  public int processRaw(short[] SDATA, long NSAMP, boolean noSearch, boolean fullUtt) {
    return PocketSphinxJNI.Decoder_processRaw(swigCPtr, this, SDATA, NSAMP, noSearch, fullUtt);
  }
  ...
  public void setJsgfString(String name, String jsgfString) {
    PocketSphinxJNI.Decoder_setJsgfString(swigCPtr, this, name, jsgfString);
  }
  ...
  public void setSearch(String searchName) {
    PocketSphinxJNI.Decoder_setSearch(swigCPtr, this, searchName);
  }
