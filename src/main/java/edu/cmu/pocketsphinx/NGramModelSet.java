...
public class NGramModelSet implements Iterable<NGramModel> {
  ...
  public NGramModel add(NGramModel model, String name, float weight, boolean reuseWidmap) {
    long cPtr = SphinxBaseJNI.NGramModelSet_add(swigCPtr, this, NGramModel.getCPtr(model), model, name, weight, reuseWidmap);
